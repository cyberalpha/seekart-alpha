...
const PaymentMethods = () => {
  ...
  return (
    <div className={`grid gap-4 ${isMobile ? 'px-2' : ''} md:gap-6 ${isMobile ? '' : 'md:grid-cols-2'}`}>
            ...
            <div key={crypto.name} className="space-y-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <Button
                  variant="outline"
                  size="icon"
                  className={`border-seekart-purple/20 hover:bg-seekart-purple/10 hover:border-seekart-purple/30 transition-all ${copyState[crypto.name] ? 'bg-green-100' : ''}`}
          ...
          <div className="space-y-2 pt-4 border-t">
            ...
            <div className="flex items-center gap-2">
              ...
              <Button
                variant="outline"
                size="icon"
                className={`border-seekart-purple/20 hover:bg-seekart-purple/10 hover:border-seekart-purple/30 transition-all ${copyState["XTOF"] ? 'bg-green-100' : ''}`}
                onClick={() => handleCopyToClipboard("0x5B015aE60Fe3CdAe53eead9aaC0c500b8298126D", "XTOF")}
              >
